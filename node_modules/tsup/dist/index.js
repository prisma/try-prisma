...
var normalizeOptions = async (logger, optionsFromConfigFile, optionsOverride) => {
  ...
  if (tsconfig) {
    ...
    if (options.dts) {
      options.dts.compilerOptions = _chunkWXLEX5S3js.__spreadValues.call(void 0, _chunkWXLEX5S3js.__spreadValues.call(void 0, {}, tsconfig.data.compilerOptions || {}), options.dts.compilerOptions || {});
    }
